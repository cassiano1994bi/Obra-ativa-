(function () {
  ...
  function plansMarkup() {
    ...
    return plans.map((plan) => `<article class="oa-price-card ${plan.featured ? 'featured' : ''}">
      ...
      <a class="oa-button" href="?app=1&onboarding=1">Criar conta grátis</a>
    </article>`).join('');
  }
  ...
  function renderPremiumProductSite() {
    ...
    document.body.innerHTML = `<main class="oa-public-site">
      <nav class="oa-public-nav"><div class="oa-public-shell">${productBrand()}<div class="oa-public-links"><a href="#recursos">Recursos</a><a href="#planos">Plano único</a><a href="#perguntas">Perguntas</a><a href="#contato">Contato</a></div><a class="oa-login-button" href="${loginUrl}">${icon('lock')} Entrar</a></div></nav>

      <section class="oa-public-hero"><div class="oa-public-shell oa-hero-grid">
        <div class="oa-hero-copy"><span class="oa-kicker">GESTÃO FEITA PARA QUEM VIVE A OBRA</span><h1>Sua obra já dá<br>trabalho demais.<br>O <em>controle não<br>precisa dar.</em></h1><p>Equipe, presença, pagamentos e financeiro por obra em um lugar simples de usar.</p><div class="oa-hero-actions"><a class="oa-button" href="${startUrl}">Criar conta grátis</a><a class="oa-button outline" href="${productSalesUrl(productSalesMessage())}" target="_blank" rel="noopener">◉ Falar no WhatsApp</a></div><div class="oa-hero-note">● 30 dias grátis · Não precisa de cartão de crédito · <a href="${demoUrl}">Ver demonstração segura</a></div></div>
      ...
      <section class="oa-public-section oa-device-section"><div class="oa-public-shell oa-device-grid">${devicesMarkup()}<div class="oa-device-copy"><span class="oa-kicker">CONTROLE NA PALMA DA MÃO</span><h2>Leve o controle da sua obra para qualquer lugar</h2><p>Acesse pelo computador, tablet ou celular. Registre presença, organize a escala e acompanhe os pagamentos.</p><div class="oa-store-row"><span>App Store <small>EM BREVE</small></span><span>Google Play <small>EM BREVE</small></span><a href="downloads/escritorio-da-minha-obra.apk">Baixar APK Android</a></div></div></div></section>
      ...
      <section class="oa-public-section oa-plans-section" id="planos"><div class="oa-public-shell"><div class="oa-plan-layout"><aside class="oa-security-card">${icon('shield')}<div><h2>Seus dados estão seguros</h2><p>Boas práticas de segurança, acesso protegido e dados separados por empresa.</p></div><div class="oa-security-points"><span>↻<b>Backup diário automático</b></span><span>▣<b>Acesso seguro</b></span><span>▤<b>Dados separados por empresa</b></span></div></aside><div><div class="oa-center-heading"><h2>Um plano completo para sua obra</h2><p>R$ 69/mês após 30 dias grátis. Todas as funcionalidades incluídas.</p></div><div class="oa-trial-strip"><b>Teste grátis de 30 dias</b><span>Acesso completo para conhecer o sistema. Sem cartão nesta fase.</span><a class="oa-button" href="${startUrl}">Criar conta grátis</a></div></div></div><div class="oa-price-grid">${plansMarkup()}</div></div></section>

      <section class="oa-public-section oa-faq-section" id="perguntas"><div class="oa-public-shell"><div class="oa-center-heading"><h2>Perguntas frequentes</h2></div><div class="oa-faq-grid"><details><summary>Como funciona o teste grátis?</summary><p>Você usa o ObraAtiva por 30 dias, sem informar cartão nesta fase.</p></details><details><summary>Posso usar no celular?</summary><p>Sim. O sistema funciona no navegador e também oferece o APK para Android.</p></details><details><summary>Posso cancelar quando quiser?</summary><p>Sim. O cancelamento não apaga automaticamente os dados da empresa.</p></details><details><summary>Quantos usuários posso adicionar?</summary><p>O plano completo não tem limite comercial de obras ou usuários. As permissões de cada pessoa e as proteções de segurança continuam valendo.</p></details><details><summary>Meus dados ficam seguros?</summary><p>As empresas possuem dados separados e controles de acesso próprios.</p></details><details><summary>Como funciona o suporte?</summary><p>O atendimento comercial e de suporte pode ser iniciado pelo WhatsApp.</p></details></div></div></section>

      <section class="oa-final-cta" id="contato"><div class="oa-public-shell"><div><h2>Pronto para ter o controle total da sua obra?</h2><p>Teste grátis por 30 dias e transforme a gestão da sua obra.</p></div><a class="oa-button" href="${startUrl}">Criar conta grátis</a><small>● Não precisa de cartão de crédito</small></div></section>

      <footer class="oa-public-footer"><div class="oa-public-shell oa-footer-grid"><div>${productBrand()}<p>Tecnologia e gestão trabalhando juntas para construir resultados reais.</p></div><nav><b>Produto</b><a href="#recursos">Recursos</a><a href="#planos">Plano único</a><a href="${productUrl('&documento=privacidade')}">Privacidade</a></nav><nav><b>Empresa</b><a href="#contato">Contato</a><a href="${productUrl('&documento=termos')}">Termos de uso</a><a href="${productUrl('&documento=cancelamento')}">Cancelamento</a></nav><nav><b>Suporte</b><a href="${productSalesUrl(productSalesMessage())}" target="_blank" rel="noopener">WhatsApp</a><a href="${loginUrl}">Entrar</a></nav><aside class="oa-creator-credit"><small>APLICATIVO DESENVOLVIDO POR</small><img src="public-assets/aplicativo-studio-logo-v1.svg" alt="AplicAtivo Tecnologia"><p>Criação de aplicativos e soluções digitais.</p><a href="${contact.url}" target="_blank" rel="noopener">WhatsApp ${safe(contact.display)}</a></aside></div><div class="oa-public-shell oa-footer-bottom"><span>© 2026 ObraAtiva</span><span>Um produto desenvolvido pela AplicAtivo Tecnologia</span></div></footer>
    </main>`;
  }
