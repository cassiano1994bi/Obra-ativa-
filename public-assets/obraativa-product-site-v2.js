(function () {
  ...
  function plansMarkup() {
    ...
    return plans.map((plan) => `<article class="oa-price-card ${plan.featured ? 'featured' : ''}">
      ...
      <a class="oa-button" href="?app=1&onboarding=1">Criar conta · 30 dias grátis</a>
    </article>`).join('');
  }
  ...
  function renderPremiumProductSite() {
    ...
    document.body.innerHTML = `<main class="oa-public-site">
      ...
      <section class="oa-final-cta" id="contato"><div class="oa-public-shell"><div><h2>Pronto para ter o controle total da sua obra?</h2><p>Teste grátis por 30 dias e transforme a gestão da sua obra.</p></div><a class="oa-button" href="${startUrl}">▣ Começar teste grátis por 30 dias</a><small>● Não precisa de cartão de crédito</small></div></section>
