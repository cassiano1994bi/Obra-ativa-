(function employeePerformanceModule(root, factory) {
  ...
  function resolveRange(filters = {}) {
    ...
    return { from, to: current, label: `Quinzena do calendário · ${displayDate(from)} a ${displayDate(current)}`, kind: 'fortnight' };
  }
