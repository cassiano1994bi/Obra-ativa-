  ...
  function installStyle() {
    ...
    document.head.insertAdjacentHTML('beforeend', `<style id="${STYLE_ID}">
      ...
      @media(max-width:600px){
        ...
        #app:not(.public-app) .top-brand span{font-size:8px!important;line-height:1.1!important;letter-spacing:.12em!important}
        ...
        #app:not(.public-app) .top .user{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:38px!important;padding:6px 9px!important;font-size:10px!important;white-space:nowrap!important}
        #app:not(.public-app) .top .top-settings-button{display:grid!important;place-items:center!important;width:42px!important;min-width:42px!important;min-height:42px!important;padding:0!important}
        ...
        #app:not(.public-app) table.mobile-ui-card-table tbody td .btn{flex:1 1 125px!important;min-width:0!important}
        ...
        body.responsive-v3-phone .dialog footer{position:sticky!important;bottom:calc(-18px - env(safe-area-inset-bottom))!important;z-index:2!important;display:grid!important;grid-template-columns:minmax(0,1fr)!important;gap:8px!important;margin:18px -14px calc(-18px - env(safe-area-inset-bottom))!important;padding:12px 14px calc(12px + env(safe-area-inset-bottom))!important;background:#fff!important;border-top:1px solid #e1e7ed!important;box-shadow:0 -8px 20px #132f4c12!important}
      ...
      @media(min-width:761px) and (max-width:1024px), (min-width:1025px) and (max-width:1366px) and (orientation:landscape) and (hover:none) and (pointer:coarse){
        ...
        #app:not(.public-app) .side>.nav-more-docked{width:100%!important;min-width:0!important;min-height:48px!important;margin:0!important;padding:8px 4px!important;border-radius:10px!important;font-size:10px!important;line-height:1.2!important;text-align:center!important;white-space:normal!important}
      ...
      @media(orientation:landscape) and (max-height:600px) and (max-width:1024px){
        ...
        #app:not(.public-app) .top-brand span{font-size:7px!important}
        #app:not(.public-app) .top-brand strong,
        ...
        #app:not(.public-app) .top .spacer{display:none!important}
        #app:not(.public-app) .top .work-select{order:0!important;flex:0 1 280px!important;width:auto!important;min-width:160px!important;max-width:300px!important;min-height:40px!important;margin:0!important;font-size:14px!important}
        #app:not(.public-app) .top .user{flex:none!important;min-height:38px!important;padding:5px 8px!important;font-size:9px!important}
        #app:not(.public-app) .top .top-settings-button{flex:0 0 42px!important;width:42px!important;min-width:42px!important;min-height:42px!important;padding:0!important}
        ...
        #app:not(.public-app) .toolbar>.btn,
        #app:not(.public-app) .toolbar>.check-line{width:100%!important;min-height:42px!important;margin:0!important}
        #app:not(.public-app) .field input,
        #app:not(.public-app) .field select,
        #app:not(.public-app) .field textarea,
        #app:not(.public-app) input,
        #app:not(.public-app) select,
        #app:not(.public-app) textarea{min-height:42px!important}
        #app:not(.public-app) .btn{min-height:42px!important;padding:8px 11px!important}
        #app:not(.public-app) .tabs,
        #app:not(.public-app) .site-management-tabs,
        ...
        #app:not(.public-app) table.responsive-v3-card-table tbody td::before,
        #app:not(.public-app) table.mobile-ui-card-table tbody td::before{content:attr(data-responsive-label)!important;flex:0 0 38%!important;max-width:38%!important;color:#6c7e90!important;font-size:9px!important;font-weight:850!important;text-align:left!important;text-transform:uppercase!important}
        #app:not(.public-app) table.responsive-v3-card-table tbody td:last-child,
        #app:not(.public-app) table.mobile-ui-card-table tbody td:last-child{flex-wrap:wrap!important;border-bottom:0!important}
        #app:not(.public-app) table.responsive-v3-card-table tbody td[colspan],
        #app:not(.public-app) table.mobile-ui-card-table tbody td[colspan]{display:block!important;grid-column:1!important;text-align:left!important}
        ...
        #app:not(.public-app) .presence .phead{display:flex!important;position:static!important;align-items:center!important;justify-content:center!important;min-width:0!important;padding:7px 5px!important;font-size:9px!important;text-align:center!important}
        ...
        #app:not(.public-app) .presence>div:nth-child(5n+1):not(.phead) .btn{width:100%!important;min-height:38px!important;margin-top:6px!important;padding:6px!important;font-size:10px!important}
        #app:not(.public-app) .presence .pchoice{width:100%!important;min-width:0!important;min-height:42px!important;padding:6px 3px!important;border-radius:9px!important;font-size:10px!important;white-space:normal!important}
        ...
        #app:not(.public-app) .side .nav .mobile-nav-label{font-size:8.5px!important;white-space:normal!important}
        ...
        #app:not(.public-app) .side .nav .mobile-more-group .mobile-nav-label{font-size:8.5px!important;white-space:normal!important}
        ...
        body.responsive-v3-landscape-phone .dialog footer{display:flex!important;flex-wrap:wrap!important;justify-content:flex-end!important;gap:8px!important;margin-top:12px!important}
      }
    </style>`);
  }
