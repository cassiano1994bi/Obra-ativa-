  ...
  function installStyle() {
    ...
    document.head.insertAdjacentHTML('beforeend', `<style id="${STYLE_ID}">
      @media(max-width:760px){
        ...
        #app:not(.public-app) .top-brand span{font-size:8px;line-height:1.1;letter-spacing:.12em}
        ...
        #app:not(.public-app) .top .user{display:inline-flex!important;align-items:center;min-height:34px;padding:6px 9px;border:1px solid #cfe7d9;border-radius:999px;background:#f0faf4;color:#1f7350;font-size:10px;font-weight:750;white-space:nowrap}
        #app:not(.public-app) .top .top-settings-button{display:grid;place-items:center;flex:0 0 42px;width:42px;min-height:42px;padding:0;border-radius:12px;font-size:18px}
        #app:not(.public-app) .top .work-select{order:5;flex:1 0 100%;width:100%;min-width:0;min-height:42px;margin:0;padding:8px 10px;border-radius:11px}
        ...
        #app:not(.public-app) .metric label{font-size:10px;line-height:1.3}
        ...
        #app:not(.public-app) .btn.sm{min-height:42px;padding:8px 10px;font-size:12px}
        ...
        #app:not(.public-app) .tabs button{flex:0 0 auto;min-height:42px;padding:9px 12px;scroll-snap-align:start;white-space:nowrap}
        ...
        #app:not(.public-app) .mobile-ui-card-table tbody td::before{content:attr(data-mobile-label);flex:0 0 auto;max-width:48%;color:#6c7e90;font-size:9px;font-weight:850;line-height:1.3;letter-spacing:.045em;text-align:left;text-transform:uppercase}
        ...
        #app:not(.public-app) .mobile-ui-card-table tbody td .btn{flex:1 1 auto;min-width:96px}
        ...
        body.mobile-ui-v2-active .dialog footer{position:sticky;bottom:calc(-18px - env(safe-area-inset-bottom));z-index:2;display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:18px -14px calc(-18px - env(safe-area-inset-bottom));padding:12px 14px calc(12px + env(safe-area-inset-bottom));background:#fff;border-top:1px solid #e1e7ed;box-shadow:0 -8px 20px #132f4c12}
        ...
        #app:not(.public-app) .side .nav .mobile-nav-label{max-width:100%;overflow:hidden;font-size:10px!important;text-overflow:ellipsis;white-space:nowrap!important}
      ...
      @media(max-width:430px){
        ...
        #app:not(.public-app) .top .user{font-size:9px;padding:5px 7px}
        ...
        #app:not(.public-app) .side .nav .mobile-nav-label{font-size:9.5px!important}
      }
    </style>`);
  }
