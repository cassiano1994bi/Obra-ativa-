...
$releaseDir = Join-Path $projectRoot 'release-android-20260830-v4-obraativa'
...
$alignedApk = Join-Path $releaseDir 'escritorio-da-minha-obra-v4-aligned.apk'
$signedApk = Join-Path $releaseDir 'escritorio-da-minha-obra-v4.apk'
$signedAab = Join-Path $releaseDir 'escritorio-da-minha-obra-v4.aab'
