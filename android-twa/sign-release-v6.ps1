...
$releaseDir = Join-Path $projectRoot 'release-android-20260831-v6-obraativa'
...
$alignedApk = Join-Path $releaseDir 'obraativa-v6-aligned.apk'
$signedApk = Join-Path $releaseDir 'obraativa-v6.apk'
$signedAab = Join-Path $releaseDir 'obraativa-v6.aab'
