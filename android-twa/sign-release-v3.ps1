...
$releaseDir = Join-Path $projectRoot 'release-android-20260829-v3-location'
...
$alignedApk = Join-Path $releaseDir 'escritorio-da-minha-obra-v3-aligned.apk'
$signedApk = Join-Path $releaseDir 'escritorio-da-minha-obra-v3.apk'
$signedAab = Join-Path $releaseDir 'escritorio-da-minha-obra-v3.aab'
