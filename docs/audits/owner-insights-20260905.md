...
- `docs/audits/index-modularization-plan.md`: inventário atualizado (41 scripts externos; nenhum handler inline novo).
...
- Scripts locais: `tests/owner-insights-database.test.mjs`, `tests/owner-insights-server.test.mjs`, `tests/product-activity.test.mjs`, `tests/owner-insights-visual-check.mjs`. Inventário confirmado em 41 scripts externos. Testes/fixtures/imagens de QA não podem ser publicados.
