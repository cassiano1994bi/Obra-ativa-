...
O inventário de modularização esperava 802 eventos; a base pública conciliada tem 803 pelo critério `\son[a-z]+=`. Documento e teste foram alinhados: 97 blocos de estilo, 16 scripts inline, 41 scripts externos e 803 eventos. O novo OwnerCenter não acrescenta handler inline.
